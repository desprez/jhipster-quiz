...
describe('Question Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { question: () => of({ id: '9fec3727-3421-4967-b213-ba36557ca194' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('Should load question on init', async () => {
      ...
      // THEN
      expect(instance.question).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
});
