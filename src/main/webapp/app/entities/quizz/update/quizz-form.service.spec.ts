      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            allowBack: expect.any(Object),
            allowReview: expect.any(Object),
            keepAnswersSecret: expect.any(Object),
            image: expect.any(Object),
            published: expect.any(Object),
            publishDate: expect.any(Object),
            attempsLimit: expect.any(Object),
            attempsLimitPeriod: expect.any(Object),
