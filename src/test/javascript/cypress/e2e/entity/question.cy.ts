...
describe('Question e2e test', () => {
  ...
  const questionSample = { statement: 'gah', index: 15485, correctOptionIndex: 21469 };
  ...
  describe('new Question page', () => {
    ...
    it('should create an instance of Question', () => {
      cy.get(`[data-cy="statement"]`).type('wolf');
      cy.get(`[data-cy="statement"]`).should('have.value', 'wolf');

      cy.get(`[data-cy="index"]`).type('8048');
      cy.get(`[data-cy="index"]`).should('have.value', '8048');

      cy.get(`[data-cy="correctOptionIndex"]`).type('24909');
      cy.get(`[data-cy="correctOptionIndex"]`).should('have.value', '24909');
